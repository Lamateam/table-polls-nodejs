      ...
      @AnswersService
        ...
        .then (res)=>
          ...
          for answer in res.answers
            ...
            if !incorrect
              genderCounter[if answer.person_male then 0 else 1]++
              answersCounter[answer.answers]++

          @data.stat.gender  = {"labels": [ "Мужчины", "Женщины" ], "datasets": [ { "data": genderCounter, "backgroundColor": [ "#455C73", "#9B59B6" ], "hoverBackgroundColor": [ "#34495E", "#B370CF" ] } ] }
